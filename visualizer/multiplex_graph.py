...
class MultiplexGraph():
    ...
    def __init__(self, path: str, n_layers: int, layout = nx.spring_layout, directed = False, ax = None, node_labels = None, path_to_node_labels = None, path_to_layer_labels = None, title = None, weighted = False):
        ...
        self.read_data(application_path + path)
        self.get_nodes()
        self.get_node_positions()
        self.get_edges_between_layers()
        self.get_edges_within_layers()
        
        if path_to_node_labels != None:
            #self.get_node_label_text(os.getcwd() + path_to_node_labels)
            self.get_node_label_text(application_path + path_to_node_labels)
        else:
            self.get_node_label_text(path_to_node_labels)
        # self.get_layer_labels(os.getcwd() + path_to_layer_labels)
        self.get_layer_labels(application_path + path_to_layer_labels)
        self.draw()
